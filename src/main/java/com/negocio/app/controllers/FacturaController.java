...
public class FacturaController {
	...
	public String guardar(@Valid Factura factura,
			BindingResult result, //permite comprobar si hubo errores en la validación de la factura
			Model model,
		...
		if (itemId == null || itemId.length == 0) {
			model.addAttribute("titulo", "Crear factura");
			model.addAttribute("error", "Error: La factura no se crea sin agregar productos");
			return "factura/formFactura";
		}
